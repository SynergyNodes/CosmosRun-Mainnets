  ...
  <div class="text-center container-lg">
    ...
    <b-link>
      <div class="d-flex justify-content-center align-items-center">
        ...
        >
        Cosmos Blockchains Explorer<small class="flow-left">Beta</small>
        </h1>
      </div>
    </b-link>

    <h2 class="mb-3">
      CosmosRun explorer maintained by <a href="https://www.synergynodes.com" target="_blank">SynergyNodes.com</a>.
    </h2>

    <h2 class="mb-3">Mainnets Explorer - Thanks to <a href="https://ping.pub" target="_blank">Pub.ping</a></h2>
